...
# SECRET_KEY = 'django-insecure-j9%i^@^i5s7@hqcs%p1l%ka)8^p(%e7-x12cw_qegmx$1*a512'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = [' https://laibrary-management-system.onrender.com','https://*.127.0.0.1']
